...
class UpdateProduct extends Component {
    ...
    handleFetch = async (e) => {
        ...
        const { data: product } = await axios.post('https://woodworks-api.onrender.com/api/updateProduct/fetch', this.state.product)
        // console.log(product)
        this.setState({
            // id: product._id,
            // title: product.title,
    ...
    handleSubmit= async()=>{
        const {data:response} = await axios.post('https://woodworks-api.onrender.com/api/updateProduct/update', this.state.product)
